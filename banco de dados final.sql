...
INSERT INTO Marcas (Nome) VALUES ('Fiat'), ('Chevrolet'), ('Volkswagen');
INSERT INTO Modelos (MarcaID, Nome) VALUES (1, 'Uno'), (2, 'Onix'), (3, 'Gol');

-- Inserção de mais dados nas tabelas Marcas e Modelos
INSERT INTO Marcas (Nome) VALUES ('Ford'), ('Toyota'), ('Honda');
...
INSERT INTO Carros (ModeloID, Ano, Preco, Cor, Quilometragem) VALUES 
(1, 2020, 35000.00, 'Vermelho', 50000),
(2, 2021, 45000.00, 'Preto', 30000),
(3, 2019, 28000.00, 'Branco', 40000);

-- Inserção de mais dados na tabela Carros
INSERT INTO Carros (ModeloID, Ano, Preco, Cor, Quilometragem) VALUES 
(4, 2018, 32000.00, 'Azul', 60000),
(5, 2022, 78000.00, 'Cinza', 10000),
(6, 2020, 72000.00, 'Prata', 15000);
...
-- Inserção de mais dados na tabela Clientes
INSERT INTO Clientes (Nome, CPF, Endereco, Telefone, Email) VALUES 
...
-- Inserção de mais dados na tabela Vendedores
INSERT INTO Vendedores (Nome, CPF, Endereco, Telefone, Email) VALUES 
...
(1, '2024-07-01', 2750.00), (1, '2024-08-01', 2750.00);

-- Inserção de mais dados na tabela Pagamentos
INSERT INTO Pagamentos (VendaID, DataPagamento, ValorPago) VALUES 
(3, '2024-08-01', 4333.33), (3, '2024-09-01', 4333.33);
